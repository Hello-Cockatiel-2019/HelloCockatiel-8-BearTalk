	...
	render(){
		return (
			<div class="row">
	            ...
	            <div class="col-1 col-md-1 col-sm-1"><AnchorLink class="hoverBtn" href="#two"><img src="/images/22.png" alt="logo 512" width="150%" /></AnchorLink></div>
	            <div class="col-1 col-md-1 col-sm-1"><AnchorLink class="hoverBtn" href="#srry"><img src="/images/33.png" alt="logo 512" width="150%" /></AnchorLink></div>
	            <div class="col-1 col-md-1 col-sm-1"><AnchorLink class="hoverBtn" href="#two"><img src="/images/44.png" alt="logo 512" width="150%" /></AnchorLink></div>
