	...
	render(){
        ...
        <div>
            ...
            <div class="row">
              ...
              <div class="col-4 col-md-4 col-sm-4">
                <Animated animationIn="zoomIn" animationInDuration="1500">
                 <a href="https://www.facebook.com/katak56"> <img src="/images/Logopng.png" alt="logo 512" width="100%" />
               </a> </Animated>
              </div>
              <div class="col-4 col-md-4 col-sm-4" >
                <Animated animationIn="bounceIn">
                  <AnchorLink class="hoverBtn" href="#content5">
            ...
            <div class="row">
              ...
              <div class="col-4 col-md-4 col-sm-4">
                <Animated animationIn="bounceIn">
                  <AnchorLink class="hoverBtn" href="#srry">
            ...
            <div id="two" style={{ backgroundImage: 'URL(/images/body.png)', backgroundRepeat: "no-repeat", backgroundSize: "100%", marginTop:"5%"}} >
             <br/>
             <br/>
             <br/>
             <br/>
